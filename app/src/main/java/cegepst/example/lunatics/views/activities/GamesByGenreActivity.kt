...
private const val TITLE = "Associated games"

class GamesByGenreActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener,
    BaseActivity {
    ...
    override fun loadContent() {
        viewModel.fetchGamesByGenre(intent.getIntExtra("genreId", 1))
